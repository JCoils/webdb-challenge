...
1. Explain the difference between `RDBMS` and `SQL`.
 ...
 The Relational Database Management System is the system that stores all of our databases and structures databases as tables made of rows and columns. Structured Query Language is the programming language used to interact with the database.


1. Why do tables need a `primary key`?

Primary key constraints identify the column or set of columns that have vaules that uniquely identify a row in a table.
...
To have a many-to-many relationship between two tables, a third table needs a to be added to act as the join table. 
